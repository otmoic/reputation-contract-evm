...
describe("Reputation", function () {
    async function setep() {
        let _agreementReachedTime = await time.latest();
...
function makeBidIdOrigin(complaint) {
    return (
        ...
        complaint.requestor +
        complaint.lpId +
        complaint.expectedSingleStepTime.toString() +
        complaint.tolerantSingleStepTime.toString() +
        complaint.earliestRefundTime.toString() +
        complaint.userSign +
        complaint.lpSign
    );
}
